            ...
            if (i == 2) {
                if (Character.toString(thousands.charAt(1)).equals("1")){
                    ...
                    if (Character.toString(thousands.charAt(2)).equals("s")) {
                        ...
                        if (Character.toString(thousands.charAt(2)).equals("1")){
                            stringBuffer.append(One.onePrint("11"));
                            stringBuffer.append(" ");
                        }else {
                            if (Character.toString(thousands.charAt(2)).equals("2")){
                                stringBuffer.append(One.onePrint("12"));
                                stringBuffer.append(" ");
                            }else {
